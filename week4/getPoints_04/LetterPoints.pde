class LetterPoints {
  ...
  void display() {
    ...
    float letterAlpha = map(dna.genes[5], 0, 1, 50, 80);
//    float letterAlpha = map(dna.genes[5], 0, 1, 80, 100);
    ...
    float letterNoise = map(dna.genes[11], 0, 1, 0.01, 0.01);

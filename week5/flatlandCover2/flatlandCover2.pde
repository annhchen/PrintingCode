...
float print_width = 640;
float print_height = 728;
float make_bigger = 5;
...
void setup()
{
  ...
  //fill in text 
  myFont = createFont("DIN", 34.5 * make_bigger);
  textFont(myFont);
  //textAlign(LEFT, TOP);
  fill(84, 0, 15);
  ...
  myFont = createFont("DIN-Light", 20 * make_bigger);
  textFont(myFont);
  //textAlign(LEFT, TOP);
  fill(84, 0, 15);
  ...
  myFont = createFont("DIN-Light", 15 * make_bigger);
  textFont(myFont);
  fill(84, 0, 15);
  ...
  println(fontList);
  myFont = createFont("DIN-Light", 25.43 * make_bigger);
  textFont(myFont);
  fill(84, 0, 15);
  text(Edwin, eigth.x, eigth.y, (eigth.w * 4) + (grid.gutterSize*3), eigth.h * 2 + grid.gutterSize);
